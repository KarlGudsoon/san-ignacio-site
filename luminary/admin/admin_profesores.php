    ...
    <aside class="nav-top">
        <nav>
            <ul>
                ...
                <li><a href="/admin/admin_cursos.php"><img class="icon" src="/assets/icons/fa6-solid--list-ol.svg"></a></li>
                <li class="seleccionada"><a href="/admin/admin_profesores.php"><img class="icon" src="/assets/icons/teacher.svg"></a></li>      
            </ul>
